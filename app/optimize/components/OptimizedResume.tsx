  ...
  return (
    <>
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        {/* Template Selector (when not in edit mode) */}
        {!isEditMode && (
          <div className="px-4 py-2 border-b border-gray-100">
            <TemplateSelector 
              selectedTemplate={selectedTemplate}
              onTemplateSelectAction={setSelectedTemplate}
            />
          </div>
        )}
            ...
            <div className="p-3 sm:p-6">
              ...
              {(editableResume.skills && Object.keys(editableResume.skills).length > 0) && (
                <TabsContent value="skills" className="mt-0 focus:outline-none">
                  <div className="space-y-4">
                    <Skills skills={response.skills} isEditMode={isEditMode} />
                  </div>
                </TabsContent>
              )}
              ...
              {(editableResume.work_experience && editableResume.work_experience.length > 0) && (
                <TabsContent value="experience" className="mt-0 focus:outline-none">
                  <div className="space-y-4">
                    <WorkExperience work_experience={response.work_experience} isEditMode={isEditMode} />
                  </div>
                </TabsContent>
              )}
