...
/**
 * Generates a classic style resume Word document
 */
export const generateClassicWordTemplate = (resumeData: ResumeData, resumeResponse: ResumeResponse | null): Document => {
    ...
    new Paragraph({
      children: [
        new TextRun({
          ...
          color: "1A56DB", // Blue color to match PDF
        }),
      ],
      ...
      new Paragraph({
        children: [
          new TextRun({
            ...
            size: 20,
            font: "Times New Roman",
            color: "4A5568", // Gray color to match PDF
          }),
        ],
        alignment: AlignmentType.CENTER,
        spacing: { after: 200 },
  ...
  // Add horizontal line after contact details (to match PDF)
  children.push(
    new Paragraph({
      children: [
        new TextRun({
          ...
          size: 12,
          font: "Times New Roman",
          color: "1A56DB", // Blue line color to match PDF
        }),
      ],
      alignment: AlignmentType.CENTER,
      spacing: { after: 300 },
